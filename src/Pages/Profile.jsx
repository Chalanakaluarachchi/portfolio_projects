  ...
  return (
    <div className='grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-[1200px] md:h-[70vh] mx-auto py-8 bg-black' id='p'>
       <div className="absolute inset-0 overflow-hidden">
        {/* Adding an animated gradient background */}
      ...
      <div className='col-span-2 px-5 my-auto ' >
        ...
        />
         ...
         <p className='text-white sm:text-lg my-6  lg:text-xl' data-aos="zoom-in-down" data-aos-duration='1600'  >
          I'm Chalana Ravishka and I am looking for internship as Full-Stack developer or UI/UX Developer
         </p>

         <div className='my-8' data-aos="fade-in" data-aos-duration='2000'>
           <a href='https://drive.google.com/file/d/1YeyRNi3KZtax5vR_zOsJ_vRBmV_Omm89/view?usp=sharing' className='px-6 py-3 w-full rounded-xl mr-4 border border-gray-400 hover:bg-gradient-to-br  from-cyan-500 to-blue-500  hover:from-cyan-700 hover:to-blue-700 text-white hover:border-none'>
           Download CV
           </a> 
