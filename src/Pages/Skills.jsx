...
const Skills = () => {
  ...
  const Backend = [
    { bskill: 'Java', level: 60, img: java },
    //{ bskill: 'Nodejs', level: 60, img: Nodejs },
    { bskill: 'Express js', level: 50, img: expressjs },
    { bskill: 'PHP', level: 40, img: php },
  ];

  const Framework  = [
    { fskill: 'React', level: 80, img: react },
  ...
  const Tools   = [
    ...
    { bskill: 'Wordpress', level: 60, img: wordpress },
  
  ];

  const Editing   = [
    { bskill: 'Adobe Photoshop', level: 60, img: AdobePhotoshop },
    { bskill: 'Adobe Lightroom  ', level: 55, img: AdobeLightroom  },
    { bskill: 'Capcut', level: 70, img: Capcut  },
