...
const Navbar = () => {
  ...
  return (
    <div className='bg-black h-[100px] text-gray-400 max-w-[1200px] mx-auto flex justify-between items-center relative z-20'>
      <h1 className='text-3xl font-bold primary ml-4 font-mono'><a href='/home'>CHALANA RAVISHKA</a></h1>
      ...
      >
        <h1 className='text-3xl font-bold primary m-4'>CHALANA RAVISHKA</h1>
